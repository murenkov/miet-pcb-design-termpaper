...
Спроектируем фильтр, пользуясь Keysight ADS.%
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{filter_response_genesys.pdf}
    \caption{АЧХ фильтра}%
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{filter_layout_genesys.pdf}
